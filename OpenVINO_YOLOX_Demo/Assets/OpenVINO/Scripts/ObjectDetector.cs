...
public class ObjectDetector : MonoBehaviour
{
    ...
    [Tooltip("A reference to the canvas for the user interface")]
    public GameObject canvas;
    [Tooltip("References to input fields for the target image width")]
    public TMPro.TMP_InputField width;
    [Tooltip("References to input fields for the target image height")]
